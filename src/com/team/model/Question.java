...
public class Question implements Serializable {
 ...
 // 생성자 1: 타자 게임용 (기존 유지)
    public Question(int id, String word) {
        this(id, QuestionType.KEYWORD, word, null, word, "키워드: " + word, null);
    }

    // 생성자 2: OX 퀴즈용 (기존 유지)
    public Question(int id, String text, String answer, String explanation) {
        this(id, QuestionType.OX, text, null, answer, explanation, null);
    }

    // 생성자 3: 빈칸 채우기 등 전체 필드용
    public Question(int id, QuestionType type, String text, String code, String answer, String explanation, String[] options) {
        this.id = id;
        this.type = type;
